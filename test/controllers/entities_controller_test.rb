...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { sentence_id: @entity.sentence_id, text: @entity.text, etype: @entity.etype } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { sentence_id: @entity.sentence_id, text: @entity.text, etype: @entity.etype } }
